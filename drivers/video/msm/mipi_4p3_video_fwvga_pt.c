...
#if (defined CONFIG_PROJECT_P825F01 ) || ( defined CONFIG_PROJECT_P865F01 )     //liyeqing change 20121025
	/* regulator */
	{0x03, 0x01, 0x01, 0x00},
	/* timing   */			/*447M*/
...
printk("wangminrong the lcd is video_fwvga_pt\r\n");
	...
	#ifdef CONFIG_PROJECT_P825A31
  pinfo.clk_rate = 452000000;
  #endif
