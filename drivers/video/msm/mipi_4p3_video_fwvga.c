...
static char otm8009a_para_CABC_0x53[2]={0x53,0x24};
...
static struct dsi_cmd_desc otm8009a_display_off_CABC_backlight_cmds[] = {
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(otm8009a_para_CABC_0x53_off), otm8009a_para_CABC_0x53_off}
};
...
static struct dsi_cmd_desc nt35110_display_off_CABC_backlight_cmds[] = {
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35110_para_CABC_0x53_off), nt35110_para_CABC_0x53_off}   
};
...
static char tianma_hx8369a02_para_CABC_0x55[2]={0x55,0x00};//zhangqi add for p825f10_sr blinking issue
static struct dsi_cmd_desc tianma_hx8369a02_display_on_CABC_backlight_cmds[] = {
	...
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(tianma_hx8369a02_para_CABC_0x55),tianma_hx8369a02_para_CABC_0x55},
};
...
static struct dsi_cmd_desc tianma_hx8369a02_display_off_CABC_backlight_cmds[] = {
	{DTYPE_DCS_WRITE1,1,0,0,0,sizeof(tianma_hx8369a02_para_CABC_0x53_off),tianma_hx8369a02_para_CABC_0x53_off}
};
...
static char otm8009a_jdf_para_0x3600[2]={0x36,0x00};
#else
...
static char otm8009a_icid_rd_para[2] = {0xa1, 0x00};  
...
#if defined ( CONFIG_PROJECT_P825A31 )
static char tianma_hx8369a02_ips_para_0x36[2]= {0x36,0x00,};    
#else
...
static char tianma_hx8369a02_ips_para_0xD5[27]= {0xD5,0x00,0x01,0x03,0x7D,0x01,0x0a,0x28,0x5a,0x11,0x13,0x00,0x00,0x60,0x04,0x71,0x05,0x00,0x00,0x71,0x05,0x60,0x04,0x07,0x0F,0x04,0x04,};//liyeqing change 20121024   zhangqi reback for resolution test
...
#if defined(CONFIG_PROJECT_P825A31)
static char tianma_hx8369a02_ips_para_0xCC[2]= {0xCC,0x02,};
#else
static char tianma_hx8369a02_ips_para_0xCC[2]= {0xCC,0x0a,};  //zhoufan
#endif
...
static char hx8379_tianma_ips_para_0xb4[32]={0xB4,0x80,0x0c,0x00,
											...
											0x08,0x30,0x30,0x04,}; 
#if defined ( CONFIG_PROJECT_P825A31 )											
static char hx8379_tianma_ips_para_0xcc[2]={0xCC,0x02};
#else
...
#if defined ( CONFIG_PROJECT_P825A31 )											
static char otm8018b_boe_4p5_param7[4] = {0xB3,0x02,0xc0,0x65};
#else
...
static int mipi_4p3_video_fwvga_lcd_on(struct platform_device *pdev)
{
	...
	printk("%s\n", __FUNCTION__);
	printk("first_init = %d, first_time_panel_on =%d mfd->cont_splash_done is %d\r\n",(unsigned int)first_init, (unsigned int)first_time_panel_on,mfd->cont_splash_done);
...
void mipi_set_backlight_4p3(struct msm_fb_data_type *mfd)
{
	 ...
	 printk("zhangqi add for CABC level=%d lcd_type=%d in %s func \n ",current_lel,lcd_id_type,__func__);
	 ...
	 if (lcd_id_type == 12 )
	 {
	   ...
	   {
		otm8009a_para_CABC_0x51[1]=(7*current_lel);     
		mipi_set_tx_power_mode(0);
	...
	else if (lcd_id_type == 13 )
	 {
	   ...
	   {
	    tianma_hx8369a02_para_CABC_0x51[1]=(7*current_lel);	    
	    mipi_set_tx_power_mode(0);
