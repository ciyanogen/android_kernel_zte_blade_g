...
#define EFFECT_ADD
#if (defined CONFIG_PROJECT_P825A20) || (defined CONFIG_PROJECT_P825F01) ||(defined CONFIG_PROJECT_P865F01) 
#include "jt8ev5_v4l2_new.h"
#else
...
static void jt8ev5_power_on(void)
{
	pr_err("%s :+++++++++++++++++=\n", __func__);
#if (defined CONFIG_PROJECT_P825F01) || (defined CONFIG_PROJECT_P825A31) || (defined CONFIG_PROJECT_P865F01) || (defined CONFIG_PROJECT_P865V30) || (defined CONFIG_PROJECT_P825T20)
	gpio_set_value(jt8ev5_power_moto_gpio, 1);   	
#endif	
	gpio_set_value(39, 1);//zhangzhao
	//usleep_range(5000, 5100);
	usleep_range(5000, 5100);
	gpio_set_value(18, 1);//[617001744332]modified by zhangzhao 2013-1-11 for JB f01 camera
	usleep_range(5000, 5100);
	gpio_set_value(jt8ev5_pwdn_gpio, 1);   	
	//gpio_set_value(jt8ev5_reset_gpio, 1);
	usleep_range(5000, 5100);
	CDBG("%s: ---------------------%d\n", __func__, __LINE__);
}
...
{
	pr_err("%s\n", __func__);
	gpio_set_value(jt8ev5_pwdn_gpio, 0);	
	//gpio_set_value(jt8ev5_reset_gpio, 0);
	usleep_range(5000, 5100);
	//gpio_set_value(39, 1);//zhangzhao
	...
	usleep_range(5000, 5100);
#if (defined CONFIG_PROJECT_P825F01) || (defined CONFIG_PROJECT_P825A31) || (defined CONFIG_PROJECT_P865F01) || (defined CONFIG_PROJECT_P865V30) || (defined CONFIG_PROJECT_P825T20)
	gpio_set_value(jt8ev5_power_moto_gpio, 0);   	
#endif	
}
...
static int32_t jt8ev5_sensor_flash_auto_state(struct msm_sensor_ctrl_t *s_ctrl, 
                                        uint8_t *AutoFlash)
{
    int32_t rc = 0;
...
static struct msm_sensor_fn_t jt8ev5_func_tbl = {
	...
	.sensor_download_af_firmware = NULL,
    	.sensor_flash_auto_state = jt8ev5_sensor_flash_auto_state,/*[617001744332]modified by zhangzhao 2012-12-4 for camera flash*/
};
