...
static struct msm_camera_i2c_reg_conf ov7692_recommend_settings[] = {
	...
	{0xb5, 0x40},
	{0xff, 0x00},
#if (defined CONFIG_PROJECT_P825F01) || (defined CONFIG_PROJECT_P825A31) || (defined CONFIG_PROJECT_P865F01) || (defined CONFIG_PROJECT_P865V30) || (defined CONFIG_PROJECT_P825B20) || (defined CONFIG_PROJECT_P825T20)
...
#if defined (CONFIG_PROJECT_P825F01) || (defined CONFIG_PROJECT_P825A31) || defined (CONFIG_PROJECT_P865F01)  ||defined (CONFIG_PROJECT_P825A20)|| defined (CONFIG_PROJECT_P865V30) || (defined CONFIG_PROJECT_P825T20)
	.sensor_id = 0x76,
#else
	.sensor_id = 0x7692,
#endif
...
{		 	
    ...
    unsigned char *camera_status = "FRONT Camera ID:OV7692-0.3M";	
