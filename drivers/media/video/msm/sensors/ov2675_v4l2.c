...
{0x3018, 0x78},//0x68
{0x3019, 0x68},//0x58
{0x301a, 0xc2},//0x62  0xd4 0x72  //yuxin modify 2013.01.23
...
//99 640 480                                                                      
//98 0 0                                                                          
{0x3013, 0x75},//0x05  yuxin 2013.01.23
{0x330c, 0x00},
{0x3301, 0xff}, 
{0x300e, 0x3a},
{0x3010 ,0x81},                                                                   
...
{0x3014,0x84},//yuxin 2013.01.22 ++
{0x3070,0x7b},//yuxin 2013.01.17 ++
{0x3071,0x00},
{0x3072,0x67},
{0x3073,0x00},  
{0x301c,0x05},  
{0x301d,0x06},//yuxin 2013.01.17 --                                                         
...
static struct msm_camera_i2c_reg_conf ov2675_snapshot_settings[] = 
{
    ...
    //99 1600 1200
    //98 0 0
    {0x3013 ,0xf0},//0x00  yuxin 2013.01.17
    {0x300e ,0x34},
    {0x3011 ,0x01},
    {0x3010 ,0x81},
    {0x3012 ,0x00},
...
//{0x3015 ,0x02},                                                                    
    ...
    {0x3070,0x5c},//yuxin 2013.01.17 ++
		{0x3071,0x00},
		{0x3072,0x4d},
		{0x3073,0x00},  
		{0x301c,0x0d},  
		{0x301d,0x10},//yuxin 2013.01.17 --       
};
...
//anti-banding
static struct msm_camera_i2c_reg_conf ov2675_antibanding[][4] = {		
       {//off.not used
		{0x308c, 0x88},  //group hold enable
		{0x3013, 0x55},
		{0x30ff, 0xff},  //end of group
		{0x30ff, 0xff},  //end of group
       },
