 ...
 * modified history
     ...
     13/02/20         maxiaoping  solve hte problem of the led don't blink after entering to early_suspend when usb
     						is inserted.						
 */
...
#if (defined CONFIG_PROJECT_P865F01) || (defined CONFIG_PROJECT_P825F01) || (defined CONFIG_PROJECT_P865F03) || (defined CONFIG_PROJECT_P865V30) || (defined CONFIG_PROJECT_P865F06) ||(CONFIG_PROJECT_P865E05)
