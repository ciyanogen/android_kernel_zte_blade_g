...
#if defined(CONFIG_PROJECT_P865E05) 
//sensors' EN GPIO pins
#define GPIO_BACK_CAM_PWDN                      122    //back cam PWDN pin 
...
#ifdef CONFIG_T4K28
static struct gpio t4k28_cam_req_gpio_tbl[] = {
    {GPIO_CAMERA_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
    {GPIO_BACK_CAM_PWDN, GPIOF_DIR_OUT, "T4K28_PWDN"},
    {GPIO_BACK_CAM_RESET,GPIOF_DIR_OUT,"T4K28_RESET"},
};
...
static struct msm_camera_gpio_conf gpio_conf_t4k28 = {
	.cam_gpio_req_tbl = t4k28_cam_req_gpio_tbl,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(t4k28_cam_req_gpio_tbl),
...
#ifdef CONFIG_GC2235
static struct gpio gc2235_cam_req_gpio_tbl[] = {
    {GPIO_CAMERA_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
    {GPIO_BACK_CAM_PWDN, GPIOF_DIR_OUT, "GC2235_PWDN"},
    {GPIO_BACK_CAM_RESET,GPIOF_DIR_OUT,"GC2235_RESET"},
};

static struct msm_gpio_set_tbl gc2235_cam_gpio_set_tbl[] = {
	{GPIO_BACK_CAM_PWDN, GPIOF_OUT_INIT_HIGH, 1000},
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,3000},
...
static struct msm_camera_gpio_conf gpio_conf_gc2235 = {
	.cam_gpio_req_tbl = gc2235_cam_req_gpio_tbl,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(gc2235_cam_req_gpio_tbl),
	.cam_gpio_set_tbl = gc2235_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(gc2235_cam_gpio_set_tbl),
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};
...
#if 0//def CONFIG_MSM_CAMERA_FLASH
...
static struct msm_camera_csi_lane_params t4k28_csi_lane_params = {
...
static struct msm_camera_sensor_platform_info sensor_board_info_t4k28 = {
	...
	.csi_lane_params = &t4k28_csi_lane_params,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_t4k28_data = {
	...
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = YUV_SENSOR,
	.autofocus_info = 1,//yuxin add for T4k28 not support AF.2013.07.16
};
...
static struct msm_camera_csi_lane_params gc2235_csi_lane_params = {
	.csi_lane_assign = 0xE4,
	.csi_lane_mask = 0xF,
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_gc2235 = {
	...
	.csi_lane_params = &gc2235_csi_lane_params,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_gc2235_data = {
	...
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
	.autofocus_info = 1,//yuxin add for gc2235 not support AF.2013.07.16
};
