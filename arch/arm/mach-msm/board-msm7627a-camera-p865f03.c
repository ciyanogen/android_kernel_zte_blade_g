...
#if defined (CONFIG_PROJECT_P865F01)  ||defined ( CONFIG_PROJECT_P825F01)  ||defined ( CONFIG_PROJECT_P825A31) || defined ( CONFIG_PROJECT_P865V30) || defined ( CONFIG_PROJECT_P865F03) || defined ( CONFIG_PROJECT_P825T20)
...
/* wangjianping 20130422 added Aptina camera sensor MT9D115 2M, start */
#ifdef CONFIG_MT9D115
static struct gpio mt9d115_cam_req_gpio_tbl[] = {
    {GPIO_CAMERA_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
    //{GPIO_CAMERA_1V8_DVDD_EN,GPIOF_DIR_OUT,"CAM_DVDD"},
    {GPIO_BACK_CAM_5MP_PWDN, GPIOF_DIR_OUT, "MT9D115_PWDN"},
    {GPIO_BACK_CAM_5MP_RESET,GPIOF_DIR_OUT,"MT9D115_RESET"},
};

static struct msm_gpio_set_tbl mt9d115_cam_gpio_set_tbl[] = {
	//{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_BACK_CAM_5MP_PWDN, GPIOF_OUT_INIT_HIGH, 1000}, 
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_HIGH, 1000},//reset active low	
	{GPIO_BACK_CAM_5MP_PWDN, GPIOF_OUT_INIT_LOW, 1000},  
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	//{GPIO_CAMERA_1V8_DVDD_EN,GPIOF_OUT_INIT_HIGH,3000},
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_LOW, 2000},
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_HIGH, 1000},

		
};
static struct msm_camera_gpio_conf gpio_conf_mt9d115 = {
	.cam_gpio_req_tbl = mt9d115_cam_req_gpio_tbl,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(mt9d115_cam_req_gpio_tbl),
	.cam_gpio_set_tbl = mt9d115_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(mt9d115_cam_gpio_set_tbl),
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};
#endif
/* wangjianping 20130422 added Aptina camera sensor MT9D115 2M, end */
...
#if defined ( CONFIG_PROJECT_P865F01)  ||defined ( CONFIG_PROJECT_P825F01)  || defined ( CONFIG_PROJECT_P825A31) ||defined ( CONFIG_PROJECT_P865V30) || defined ( CONFIG_PROJECT_P865F03) || defined ( CONFIG_PROJECT_P825T20) ||defined(CONFIG_PROJECT_P865F06)
...
static struct msm_camera_sensor_info msm_camera_sensor_sp0a28_data = {
	...
	.vcm_pwd        = GPIO_CAMERA_2V8_AVDD_EN,
	#endif  
	.pdata                  = &msm_camera_device_data_csi0[0],
...
static struct msm_camera_sensor_info msm_camera_sensor_mt9d115_data = {
	...
	.csi_if                 = 1,
	.camera_type = BACK_CAMERA_2D,  // FRONT_CAMERA_2D  BACK_CAMERA_2D
	.sensor_type = YUV_SENSOR,
    .autofocus_info = 1, 
};
#endif
