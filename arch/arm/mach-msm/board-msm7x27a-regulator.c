...
#if defined ( CONFIG_PROJECT_P825A10 ) || defined ( CONFIG_PROJECT_P825F01 ) || defined ( CONFIG_PROJECT_P825A31 ) || defined ( CONFIG_PROJECT_P865F01 ) || defined ( CONFIG_PROJECT_P865E02 ) ||defined ( CONFIG_PROJECT_V72A )|| defined ( CONFIG_PROJECT_P865V30 ) || defined ( CONFIG_PROJECT_P825T20 )|| defined ( CONFIG_PROJECT_P865F06 )||defined(CONFIG_PROJECT_P865E05)
	PCOM_VREG_LDO(ldo19, 57, NULL, 1200000, 1800000, 0, -1, 0, 0, 0, 0, p),
#else
    PCOM_VREG_LDO(ldo19, 57, NULL, 2800000, 3050000, 0, -1, 1, 0, 0, 0, p),
#endif	
