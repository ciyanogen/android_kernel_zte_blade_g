...
#define GPIO_FRONT_CAM_RESET                   0XFF  //front cam RESET pin 
#define GPIO_BACK_CAM_PWDN                      42    //back cam PWDN pin 
#define GPIO_BACK_CAM_RESET                     27  //back cam RESET pin 
//cam power supply LDO En GPIO pins
#define GPIO_CAMERA_2V8_AVDD_EN                 0XFF   //AVDD 2.8V LDO EN pin
#define GPIO_CAMERA_1V8_DVDD_EN               0xFF   //DVDD AND IOVDD 1.8V LDO EN pin
...
static struct camera_vreg_t msm_cam_vreg[] = {
	...
	{"wlan4", REG_LDO, 2800000, 2800000, 0},
};
#else  //Qualcomm org code
static struct camera_vreg_t msm_cam_vreg[] = {
	{"msme1", REG_LDO, 1800000, 1800000, 0},
...
#if defined( CONFIG_PROJECT_P865E02)|| defined( CONFIG_PROJECT_P865E04)
