...
#if defined (CONFIG_PROJECT_P865F01)  ||defined ( CONFIG_PROJECT_P825F01) || defined ( CONFIG_PROJECT_P825A31 )|| defined ( CONFIG_PROJECT_P865V30) || defined ( CONFIG_PROJECT_P825T20 )
...
#define GPIO_CAMERA_1V8_EN  120 //modified by zhangzhao 2013-1-11 JB F01 CAMERA
...
#ifdef CONFIG_OV7692
#if defined ( CONFIG_PROJECT_P865F01)  ||defined ( CONFIG_PROJECT_P825F01) || defined ( CONFIG_PROJECT_P825A31 )||defined ( CONFIG_PROJECT_P865V30) || defined ( CONFIG_PROJECT_P825T20 )  //yuxin modify for P825F01 front cam ov7692 2012.09.21
...
static struct msm_camera_gpio_conf gpio_conf_ov7692 = {
	//.cam_gpio_req_tbl = ov7692_cam_req_gpio,//modified by zhangzhao 2013-1-11 JB F01 CAMERA
...
static struct msm_camera_sensor_info msm_camera_sensor_jt8ev5_data = {
	...
	.sensor_reset   = GPIO_BACK_CAM_5MP_RESET,
	.sensor_pwd     = GPIO_BACK_CAM_5MP_PWDN,
	.power_moto_gpio    = GPIO_CAMERA_2V8_MOTO_EN,//modified by zhangzhao 2013-1-11 JB F01 CAMERA
	.pdata                  = &msm_camera_device_data_csi1[0],
...
//modified by zhangzhao 2013-1-11 JB F01 CAMERA
...
static void camera_power_init(void)
{
	...
	gpio_direction_output(GPIO_CAMERA_2V8_MOTO_EN,1);
...
#endif
		evb_camera_gpio_cfg();
		camera_power_init();//modified by zhangzhao 2013-1-11 JB F01 CAMERA
