...
static int msm_fb_detect_panel(const char *name)
{
	...
	//wangminrong --
//wangminrong ++
#if  defined(CONFIG_PROJECT_P825A20) || defined(CONFIG_PROJECT_P865E01) || defined(CONFIG_PROJECT_P865E02) || defined(CONFIG_PROJECT_P825T20)|| defined(CONFIG_PROJECT_P865E04)||defined(CONFIG_PROJECT_P865E05)
	if (!strncmp(name, VIDEO_WVGA_PANEL_NAME,strnlen(VIDEO_WVGA_PANEL_NAME,
					PANEL_NAME_MAX_LEN)))
				return 0;
#endif
#if  defined(CONFIG_PROJECT_P825F01) || defined(CONFIG_PROJECT_P825A31) || defined(CONFIG_PROJECT_P865F01) || defined(CONFIG_PROJECT_P865V30) || defined(CONFIG_PROJECT_P865F06) 
...
static struct regulator_bulk_data regs_dsi[] = {
	...
	{ .supply = "gp2",   .min_uV = 2850000, .max_uV = 2850000 },	
#else
	{ .supply = "bt",   .min_uV = 2900000, .max_uV = 2900000 },
	//{ .supply = "gp2",   .min_uV = 2850000, .max_uV = 2850000 },
	//{ .supply = "msme1", .min_uV = 1800000, .max_uV = 1800000 },
#endif	
