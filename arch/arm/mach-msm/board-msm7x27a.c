...
static struct gpio_led android_led_list[] = {
	{
		...
		.gpio = 116,
		#elif defined(CONFIG_PROJECT_P865F03) || defined ( CONFIG_PROJECT_P865F06 )	||defined(CONFIG_PROJECT_P865E05)	
		.gpio = 34,		
...
/*ECID:0000 2012-6-18 zhangzhao modified the I2C frequency start*/
	...
	{ GPIO_CFG(61, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),
		"qup_sda" },
#if defined(CONFIG_PROJECT_P825A31)
...
#if defined(CONFIG_PROJECT_P865E01)||defined(CONFIG_PROJECT_P865E02)||defined(CONFIG_PROJECT_P865E04)||defined(CONFIG_PROJECT_P825B20) //zhangzhao 2012-12-6 optimize the camera start up time for B20
...
static struct msm_i2c_platform_data msm_gsbi0_qup_i2c_pdata = {
	.clk_freq		= 400000,/*ECID:0000  2013.07.19 yuxin modified the I2C frequency */
	.msm_i2c_config_gpio	= gsbi_qup_i2c_gpio_config,
};
#else
static struct msm_i2c_platform_data msm_gsbi0_qup_i2c_pdata = {
...
static void msm_hsusb_vbus_power(unsigned phy_info, int on)
{
	...
	printk("msm_hsusb_vbus_power config GPIO  %d \n", on);	
	if(first_time == 0)
	{
		rc = gpio_request(ZTE_CHARGE_CEN, "charge_en");
	if (rc < 0) {
		printk("failed to request %d GPIO\n", ZTE_CHARGE_CEN);
		return;
	}
	first_time =1;
	}
        ...
        if (rc < 0) {
                printk("%s: gpio_direction_input light_sensor_irq failed %d\n", __func__, rc);
        }	
	gpio_direction_output(ZTE_CHARGE_CEN, on);	
	gpio_set_value_cansleep(ZTE_CHARGE_CEN, on);	
	printk("msm_hsusb_vbus_power: config GPIO109 finished.\n");
#endif
...
//doumingming 20130508 boot_reason for using in kernel start
unsigned int boot_reason_kernel = 0;
static int __init zte_boot_reson_setup(char *p)
{
    boot_reason_kernel =memparse(p, NULL);
    return 0;
}
early_param("boot_reason", zte_boot_reson_setup);
//doumingming 20130508 boot_reason for using in kernel end
...
#ifndef CONFIG_CHARGER_MAX8903
static u32 msm_calculate_batt_capacity(u32 current_voltage);

static struct msm_psy_batt_pdata msm_psy_batt_data = {
	.voltage_min_design     = 3200,
	.voltage_max_design     = 4200,
	.voltage_fail_safe      = 3600,
...
#ifdef CONFIG_CHARGER_MAX8903
#define MAX8903_CHG_CEN 109
#define MAX8903_CHG_CHG PMIC_GPIO_10
#define MAX8903_CHG_FLT 	PMIC_GPIO_8
#define MAX8903_CHG_DCM 29
//#define MAX8903_CHG_USUS PMIC_GPIO_1

static struct max8903_pdata max8903_dev_data = {
	
	 .cen = MAX8903_CHG_CEN ,/* Charger Enable input */
	 /*.dok ->PM8029 CBLPWR  DC(Adapter) Power OK output */
	 /* uok ->USB Power OK output not connected*/
	.chg = MAX8903_CHG_CHG ,  /* Charger status output */
	.flt = MAX8903_CHG_FLT,    /* Fault output */
	.dcm = MAX8903_CHG_DCM, /* Current-Limit Mode input (1: DC, 2: USB) */
	//.usus = MAX8903_CHG_USUS,  /* USB Suspend Input (1: suspended) ,V72A new board this pin no connect.*/
	.dc_valid = true,
...
static struct platform_device max8903_batt_device = {
	.name			= "max8903-charger",
	.dev			= {
		.platform_data	= &max8903_dev_data,
	},
};
#endif
...
#ifndef CONFIG_BLOCK_UART_PRINT
...
#if defined(CONFIG_PROJECT_P825B20)||defined(CONFIG_PROJECT_P825A20)||defined(CONFIG_PROJECT_P865E04)
#define ACC_SENSOR_I2C_NUM 0
#define AKM_SENSOR_I2C_NUM 0
#define TAOS_SENSOR_I2C_NUM 1
#define GYRO_SENSOR_I2C_NUM 0
#elif defined(CONFIG_PROJECT_P865E02)||defined(CONFIG_PROJECT_P865E05)
...
#if defined(CONFIG_PROJECT_P865E04)
...
static struct lis3dh_acc_platform_data lis3dh_pdata = {
	...
	.negate_y = 0,      //y = -y 
	.negate_z = 1,      //z = +z 
#elif defined(CONFIG_PROJECT_P825F01)|| defined ( CONFIG_PROJECT_P865F06 ) || defined ( CONFIG_PROJECT_P865E04 )// modified by yangze 20130514
	.axis_map_x = 0,      //x = x
	.axis_map_y = 1,      //y = y
	.axis_map_z = 2,      //z = z 
	.negate_x = 1,      //x = -x 
...
static  struct akm8963_platform_data akm8963_pdata = { 
    #if defined(CONFIG_PROJECT_P865E02)||defined(CONFIG_PROJECT_P865F03)|| defined ( CONFIG_PROJECT_P865F06 )||defined(CONFIG_PROJECT_P865E05)
        .layout = 7,
    #elif defined(CONFIG_PROJECT_V72A)||defined(CONFIG_PROJECT_P825A31)
        .layout = 3,
    #elif defined(CONFIG_PROJECT_P825B20)||defined(CONFIG_PROJECT_P825A20)
        .layout = 5,
	#elif defined (CONFIG_PROJECT_P825T20) // yangze 20130422
		.layout = 8,
    #else
        .layout = 7,
    #endif
...
static struct kxtik_platform_data kxtik_pdata = {
	...
	.negate_y = 0,      //y = -y 
	.negate_z = 1,      //z = +z 
#elif defined(CONFIG_PROJECT_P825F01)|| defined ( CONFIG_PROJECT_P865F06 ) // modified by yangze 20130514
	.axis_map_x = 0,      //x = x
	.axis_map_y = 1,      //y = y
	.axis_map_z = 2,      //z = z 
	.negate_x = 1,      //x = -x 
...
static void sensor_power_init(void)
{
	...
	if(sensor_reg_ldo){
		...
		ret = regulator_set_voltage(sensor_reg, 3300000, 3300000);
		#else
