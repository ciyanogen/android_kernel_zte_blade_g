...
#if defined ( CONFIG_PROJECT_P825A10 ) || defined ( CONFIG_PROJECT_P825F01 ) || defined ( CONFIG_PROJECT_P825A31 ) || defined ( CONFIG_PROJECT_P865F01 )|| defined ( CONFIG_PROJECT_P865E02 )\
	||defined(CONFIG_PROJECT_V72A)  || defined ( CONFIG_PROJECT_P865F03 ) || defined ( CONFIG_PROJECT_P865V30 ) || defined ( CONFIG_PROJECT_P825T20 ) || defined ( CONFIG_PROJECT_P865F06 )\
	||defined(CONFIG_PROJECT_P865E05)
...
static struct mmc_platform_data sdc1_plat_data = {
	...
	.status_irq = MSM_GPIO_TO_INT(ZTE_GPIO_SDCARD_DET),  
